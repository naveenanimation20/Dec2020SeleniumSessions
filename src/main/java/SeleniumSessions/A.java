...
public class A {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// driver.get(args[0]);
		driver.get(
				"https://www.espncricinfo.com/series/west-indies-in-bdesh-2020-21-1244017/bangladesh-vs-west-indies-2nd-test-1244026/full-scorecard");
		...
		System.out.println(
				"Match: " + s1.substring(0, s1.indexOf("Innings")) + " v/s " + s2.substring(0, s2.indexOf("Innings")));
		System.out.println();
		...
		String batsmen = driver
				.findElement(By
						.xpath("" + "//div[@id='gp-inning-00']//div[@class='wrap header']/div[@class='cell batsmen']"))
				.getText();
		List<WebElement> headers = driver.findElements(
				By.xpath("" + "//div[@id='gp-inning-00']//div[@class='wrap header']/div[@class='cell runs']"));
